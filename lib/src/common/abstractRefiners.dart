...
abstract class MergingRefiner implements Refiner {
    bool shouldMergeResults(
        String textBetween,
        ParsingResult currentResult,
        ParsingResult nextResult,
        ParsingContext context
    );

    ParsingResult mergeResults(
        String textBetween,
        ParsingResult currentResult,
        ParsingResult nextResult,
        ParsingContext context
    ...
    @override
      List<ParsingResult> refine(ParsingContext context, List<ParsingResult> results) {
        ...
        for (int i = 1; i < results.length; i++) {
            ...
            final textBetween = context.text.substring(curResult!.index + curResult.text.length, nextResult.index);
