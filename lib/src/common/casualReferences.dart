...
ParsingComponents now(ReferenceWithTimezone reference) {
    ...
    if (reference.timezoneOffset != null) {
        component.assign(Component.timezoneOffset, targetDate.timeZoneOffset.inMinutes);
    }
...
ParsingComponents tonight(ReferenceWithTimezone reference, [ int implyHour = 22 ]) {
    final targetDate = dayjs.Day.fromDateTime(reference.instant);
    final component = ParsingComponents(reference, {});
    assignSimilarDate(component, targetDate);
...
ParsingComponents lastNight(ReferenceWithTimezone reference, [ int implyHour = 0 ]) {
    var targetDate = dayjs.Day.fromDateTime(reference.instant);
    final component = ParsingComponents(reference, {});
...
ParsingComponents evening(ReferenceWithTimezone reference, [ int implyHour = 20 ]) {
    final component = ParsingComponents(reference, {});
    component.imply(Component.meridiem, Meridiem.PM.id);
    component.imply(Component.hour, implyHour);
...
ParsingComponents yesterdayEvening(ReferenceWithTimezone reference, [ int implyHour = 20 ]) {
    var targetDate = dayjs.Day.fromDateTime(reference.instant);
    final component = ParsingComponents(reference, {});
    targetDate = targetDate.add(-1, "day")!;
    assignSimilarDate(component, targetDate);
...
ParsingComponents morning(ReferenceWithTimezone reference, [ int implyHour = 6 ]) {
    final component = ParsingComponents(reference, {});
...
ParsingComponents afternoon(ReferenceWithTimezone reference, [ int implyHour = 15 ]) {
    final component = ParsingComponents(reference, {});
    component.imply(Component.meridiem, Meridiem.PM.id);
    component.imply(Component.hour, implyHour);
    component.imply(Component.minute, 0);
